 ...
 ***** These pin numbers will probably not work with your hardware *****
 pin 13 is connected to the DataIn //12
 pin 12 is connected to the CLK //11
 pin 11 is connected to LOAD //10
 We have only a single MAX72XX.
 */
//LedControl lc=LedControl(13,12,11,1);

LedControl lc=LedControl(10,11,12,1); // Pins set for Arduino Mini Breakout
...
float greenVCC = 12.9;    // Green LED l21 on if above this voltage
float yellowVCC = 12.5;    // Yellow LED l22 on if above this voltage & below greenVCC... below turn on only RED l23
...
void loop() {        
 ...
 if (ESBmode==false) {operatingSEQ(); lc.clearDisplay(0);Serial.println("\tNot ESB");}
   else {ESBoperatingSEQ();Serial.println("\tESB");}
   // blankCBI();
